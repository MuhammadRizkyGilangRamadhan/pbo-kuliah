 ...
 */
public class MataKuliahViewFrame extends javax.swing.JFrame {

    /**
     * Creates new form MataKuliahViewFrame
     */
    public MataKuliahViewFrame() {
        initComponents();
    }
        ...
        if(barisTerpilih >= 0){
            ...
            if(pilihan == 0){
                try {
                    ...
                    String deleteSQL = "DELETE FROM matakuliah WHERE id="+id;
    ...
    private void cariButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariButtonActionPerformed
        try {
            ...
            Connection koneksi = Basisdata.getConnection();
            String selectSQL = "SELECT * FROM kuliah WHERE matakuliah like '%"+kataKunci+"%' ";
            Statement statement = koneksi.createStatement();
            ...
            while(resultSet.next()){
                row[0] = resultSet.getInt("id_mata_kuliah");
                row[1] = resultSet.getString("nama_mata_kuliah");
                row[2] = resultSet.getString("sks");
    ...
    private void tambahButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahButtonActionPerformed
        int id = 0;
        MataKuliahAddFrame f = new MataKuliahAddFrame(id);
        f.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MataKuliahViewFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MataKuliahViewFrame().setVisible(true);
            }
        });
    }
    ...
    private void formWindowActivated(Object object) {
        ...
        try {
            Connection koneksi = Basisdata.getConnection();
            String selectSQL = "SELECT * FROM matakuliah";
            Statement statement = koneksi.createStatement();
            ResultSet resultSet = statement.executeQuery(selectSQL);
